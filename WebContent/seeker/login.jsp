	...
	<div class="social-icons">
		...
		<form action="../LoginController" method="post">
		    <div class="lable"><!-- lable-2 -->
			     ...
			     <label>Email</label>
			     	<input type="email" name="email" class="text" placeholder="your@email.com " onfocus="this.placeholder = '';" onblur="if (this.placeholder == '') {this.placeholder = 'Qualification ';}">
			     </div>
		         <div class="col_1_of_2 span_1_of_2">		         
			     <label>Date of birth</label>
		         	<input type="date"  name="dob" class="text" placeholder="your date of birth" onfocus="this.placeholder = '';" onblur="if (this.placeholder == '') {this.placeholder = 'dob';}">
		         </div>
		   		<div class="clear"></div>
		   		<div class="lable-2"><!-- lable-2 -->
		        <input type="password" name="password" class="text" placeholder="My password" onfocus="this.placeholder = '';" onblur="if (this.placeholder == '') {this.placeholder = 'My password';}">
		   		<div class="clear"></div>
		   </div>
		   </div>
