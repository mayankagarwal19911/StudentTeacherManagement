...
public class RegistrationDAO {
	 ...
	 */
	public boolean registrationDAO(RegistrationClass registrationclass){
		...
		try{
			 ...
			 */
			String hql = "select email from RegistrationClass where email = '"+registrationclass.getEmail()+"' ";
