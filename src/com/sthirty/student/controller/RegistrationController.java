...
import com.sthirty.student.business.StudentRegistration;
...
public class RegistrationController extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		boolean status = studentregistration.registerStudent(registrationclass);
		if(status){
			...
			response.sendRedirect("studentemailAlreadyRegisteredRedirect.jsp");
		}
	}
}
