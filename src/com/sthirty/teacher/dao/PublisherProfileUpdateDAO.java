 ...
 * 
 * This DAO class will update Publisher profile 
 * information in database.
 */
public class PublisherProfileUpdateDAO {
	 ...
	 */
	public boolean publisherProfileUpdate(PublisherRegistrationClass registrationclass){
		try{
			/**
			 ...
			 */
			Query queryforprofileupdate = hibernatesession.createQuery("update PublisherRegistrationClass set firstname=:fname, lastname=:lname, email=:studentemail, contactnumber=:contact, dob=:studentdob, qualification=:highestqualification, addressline1=:address1, addressline2=:address2, zip=:zipcode, city=:residentcity, state=:residentstate, country=:residentcountry where publisherId=:publisherid");
			...
			queryforprofileupdate.setParameter("publisherid", registrationclass.getPublisherId());
			/**
			 * Execute Update 
			 */
			 ...
			 */
			transaction.commit();
			System.out.println(registrationclass.getPublisherId());
			status = true;
		}
